...
public record ContactData(String firstname, String lastname, String address, String mobile, String work, String email) {
    ...
    public ContactData withAddress(String address) {
        return new ContactData(this.firstname, this.lastname, address, this.mobile, this.work, this.email);
    }
    ...
    public ContactData withWork(String work) {
        return new ContactData(this.firstname, this.lastname, this.address, this.mobile, work, this.email);
    }

    public ContactData withEmail(String email) {
        return new ContactData(this.firstname, this.lastname, this.address, this.mobile, this.work, email);
    }
}